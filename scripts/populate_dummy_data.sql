...
-- Insert jobs
INSERT INTO jobs (employer_id, title, description, location, job_type, salary_min, salary_max, experience_level, required_skills, status, created_at, updated_at) VALUES
(1, 'Senior Backend Developer', 'We are looking for an experienced backend developer to join our engineering team. You will be responsible for designing and implementing scalable APIs, working with microservices architecture, and collaborating with cross-functional teams to deliver high-quality software solutions.', 'Beirut, Lebanon', 'full_time', 2500.00, 4000.00, 'Senior', ARRAY['Go', 'PostgreSQL', 'Docker', 'Microservices'], 'active', NOW(), NOW()),

(2, 'Frontend React Developer', 'Join our dynamic frontend team to build beautiful and responsive user interfaces. You will work with React, TypeScript, and modern web technologies to create exceptional user experiences for our fintech platform.', 'Remote', 'full_time', 2000.00, 3500.00, 'Mid-level', ARRAY['React', 'TypeScript', 'JavaScript', 'CSS'], 'active', NOW(), NOW()),

(3, 'DevOps Engineer', 'We need a skilled DevOps engineer to manage our cloud infrastructure and CI/CD pipelines. You will work with AWS, Kubernetes, and automation tools to ensure our systems are scalable, secure, and reliable.', 'Dubai, UAE', 'full_time', 3000.00, 5000.00, 'Senior', ARRAY['AWS', 'Kubernetes', 'Docker', 'Terraform'], 'active', NOW(), NOW()),

(4, 'Blockchain Developer', 'Exciting opportunity to work on cutting-edge blockchain projects. You will develop smart contracts, DeFi protocols, and blockchain-based applications using Solidity and other blockchain technologies.', 'Riyadh, Saudi Arabia', 'full_time', 2800.00, 4500.00, 'Mid-level', ARRAY['Solidity', 'Web3', 'JavaScript', 'Blockchain'], 'active', NOW(), NOW()),

(5, 'AI/ML Engineer', 'Join our AI team to develop machine learning models and AI-powered healthcare solutions. You will work with Python, TensorFlow, and medical data to create innovative healthcare technologies.', 'Cairo, Egypt', 'full_time', 2200.00, 3800.00, 'Mid-level', ARRAY['Python', 'TensorFlow', 'Machine Learning', 'AI'], 'active', NOW(), NOW()),

(1, 'Full Stack Developer', 'We are seeking a versatile full-stack developer to work on our web applications. You will handle both frontend and backend development, working with modern technologies and agile methodologies.', 'Beirut, Lebanon', 'full_time', 1800.00, 3000.00, 'Entry-level', ARRAY['JavaScript', 'Node.js', 'React', 'PostgreSQL'], 'active', NOW(), NOW()),

(2, 'Product Manager', 'Lead product development for our fintech platform. You will work with engineering teams, stakeholders, and customers to define product requirements and drive product strategy.', 'Remote', 'full_time', 2500.00, 4000.00, 'Senior', ARRAY['Product Management', 'Agile', 'User Research', 'Strategy'], 'active', NOW(), NOW()),

(3, 'Data Scientist', 'Analyze large datasets to extract insights and build predictive models. You will work with Python, R, and various ML frameworks to solve complex business problems.', 'Dubai, UAE', 'full_time', 2300.00, 4000.00, 'Mid-level', ARRAY['Python', 'R', 'Machine Learning', 'Statistics'], 'active', NOW(), NOW());
