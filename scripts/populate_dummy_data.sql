...
(1, 'Ali', 'Awada', '🚀 Full-Stack Developer | Turning Ideas into Scalable Web Apps', 'Passionate full-stack developer with 3+ years of experience building modern web applications. Expert in React, Node.js, and cloud technologies. I love solving complex problems and creating user-friendly solutions.', '+961 81148209', 'Lebanon, Beirut', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=600&fit=crop&crop=face', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&crop=face', ARRAY['Python', 'Java', 'Go', 'React', 'Node.js', 'PostgreSQL'], 'Mid-level', NOW(), NOW()),

(2, 'Sarah', 'Khalil', 'Backend Engineer | Go & Microservices Specialist', 'Experienced backend engineer specializing in Go, microservices architecture, and distributed systems. Passionate about clean code, performance optimization, and scalable solutions.', '+961 70123456', 'Lebanon, Tripoli', 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=400&h=600&fit=crop&crop=face', 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=200&h=200&fit=crop&crop=face', ARRAY['Go', 'Docker', 'Kubernetes', 'PostgreSQL', 'Redis', 'gRPC'], 'Senior', NOW(), NOW()),

(3, 'Omar', 'Hassan', 'Frontend Developer | React & TypeScript Expert', 'Creative frontend developer with expertise in React, TypeScript, and modern web technologies. Focused on creating beautiful, responsive, and accessible user interfaces.', '+961 81123456', 'Lebanon, Sidon', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=600&fit=crop&crop=face', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face', ARRAY['React', 'TypeScript', 'JavaScript', 'CSS', 'HTML', 'Tailwind'], 'Mid-level', NOW(), NOW()),

(4, 'Lina', 'Merhi', 'Data Scientist | Machine Learning & AI', 'Data scientist with a strong background in machine learning, statistical analysis, and AI. Experienced in Python, R, and various ML frameworks. Passionate about extracting insights from data.', '+961 70123458', 'Lebanon, Byblos', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=600&fit=crop&crop=face', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&h=200&fit=crop&crop=face', ARRAY['Python', 'R', 'TensorFlow', 'PyTorch', 'Pandas', 'NumPy'], 'Senior', NOW(), NOW()),

(5, 'Youssef', 'Farhat', 'DevOps Engineer | Cloud & Infrastructure', 'DevOps engineer specialized in cloud infrastructure, CI/CD pipelines, and automation. Expert in AWS, Docker, Kubernetes, and infrastructure as code.', '+961 81123458', 'Lebanon, Tyre', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=600&fit=crop&crop=face', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop&crop=face', ARRAY['AWS', 'Docker', 'Kubernetes', 'Terraform', 'Jenkins', 'Linux'], 'Senior', NOW(), NOW());
...
(6, 'TechCorp Solutions', 'Technology', 'https://techcorp.com', 'Leading technology company specializing in enterprise software solutions. We build innovative products that help businesses scale and succeed in the digital age.', 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=200&h=200&fit=crop', 'Beirut, Lebanon', '100-500', NOW(), NOW()),

(7, 'StartupX', 'Fintech', 'https://startupx.com', 'Fast-growing fintech startup revolutionizing digital payments and financial services. We are building the future of banking with cutting-edge technology.', 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=200&h=200&fit=crop', 'Beirut, Lebanon', '10-50', NOW(), NOW()),

(8, 'BigTech International', 'Technology', 'https://bigtech.com', 'Global technology giant with offices worldwide. We develop next-generation software solutions and provide cutting-edge technology services to millions of users.', 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=200&h=200&fit=crop', 'Dubai, UAE', '1000+', NOW(), NOW()),

(9, 'FinTech Innovations', 'Financial Services', 'https://fintech-innovations.com', 'Innovative financial technology company focused on blockchain, cryptocurrency, and digital banking solutions. We are shaping the future of finance.', 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=200&h=200&fit=crop', 'Riyadh, Saudi Arabia', '50-100', NOW(), NOW()),

(10, 'HealthTech Solutions', 'Healthcare', 'https://healthtech.com', 'Healthcare technology company developing AI-powered medical solutions and telemedicine platforms. We are improving healthcare accessibility through technology.', 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=200&h=200&fit=crop', 'Cairo, Egypt', '100-500', NOW(), NOW());
